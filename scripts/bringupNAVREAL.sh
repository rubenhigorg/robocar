...
run rosbridge    ros2 launch rosbridge_server rosbridge_websocket_launch.xml call_services_in_new_thread:=true default_call_service_timeout:=5.0 send_action_goals_in_new_thread:=true websocket_ping_interval:=10.0 websocket_ping_timeout:=30.0
sleep 2
