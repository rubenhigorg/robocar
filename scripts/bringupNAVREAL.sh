...
run mcp          python3 ~/robocar/src/robocar_pkg/robocar_pkg/mcp_server_node.py
run rosbridge    ros2 launch rosbridge_server rosbridge_websocket_launch.xml call_services_in_new_thread:=true send_action_goals_in_new_thread:=true default_call_service_timeout:=5.0
sleep 2
