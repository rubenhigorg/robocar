...
for pass in 1 2; do for n in bt_navigator controller_server planner_server behavior_server lifecycle_manager; do pkill -9 -f "$n" 2>/dev/null; done; sleep 1; done
sleep 1
